...
for file in file_names:
    ...
    while len(saving_list_sorted) != 0:
        ...
        if a != b:
            ...
            time_check1 = time_checker(new_sub1, time_matrix, servicetime, readytime, duetime)
            time_check2 = time_checker(new_sub2, time_matrix, servicetime, readytime, duetime)
    ...
    # Ini_tour = [[0, 19, 23, 21, 18, 25, 0], [0, 22, 20, 24, 0], [0, 2, 5, 8, 7, 6, 3, 1, 4, 0], [0, 14, 12, 16, 15, 11, 9, 10, 13, 17, 0]]
    # Ini_tour = [[0, 22, 19, 18, 21, 23, 25, 24, 20, 0], [0, 2, 5, 8, 7, 6, 4, 3, 1, 0], [0, 12, 14, 16, 15, 11, 10, 9, 13, 17, 0]]


    print(E_Tour)
    print('0', total_distance(E_Tour, dist_matrix), len(E_Tour))
    for tour in E_Tour:
...
Solution = [[0, 1, 2, 12, 13, 11, 10, 14, 0], [0, 15, 17, 16, 28, 26, 0], [0, 23, 24, 25, 22, 21, 20, 19, 18, 0], [0, 27, 6, 7, 5, 4, 3, 9, 8, 0]]
for tour in Solution:
    print(time_checker(tour, time_matrix, servicetime, readytime, duetime))
    print(sum(demand[tour]))

#[[0, 1, 2, 12, 13, 11, 10, 14, 0], [0, 26, 28, 16, 15, 0], [0, 23, 24, 25, 22, 21, 20, 19, 18, 0], [0, 17, 9, 8, 3, 4, 5, 7, 6, 27, 0]]
