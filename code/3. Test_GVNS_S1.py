...
for file in file_names:
    ...
    unrouted_cust = list(range(1, cust_size + 1))
    Sub_tour_S1 = []
        ...
        while True:
            ...
            for i in range(len(unrouted_cust)):
                ...
                for p in range(len(tour) - 1):
                    ...
                    time_check_si = time_checker(new_tour, dist_matrix, servicetime, readytime, duetime)
                    ...
                    if time_check_si and new_capacity <= capacity:
                        c11 = dist_matrix[tour[p]][u] + dist_matrix[u][tour[p + 1]] - muy * dist_matrix[tour[p]][
                            tour[p + 1]]
                        c12 = begin_time(new_tour, dist_matrix, servicetime, readytime)[p + 2] - \
                              begin_time(tour, dist_matrix, servicetime, readytime)[p + 1]
